...
const TermsAndConditions = () => {
  return (
    ...
    <div className="flex items-center justify-center  min-h-screen  p-6 font-bold ">
      <div className="whole bg-gradient-to-r from-white to-white shadow-lg rounded-lg p-6 max-w-4xl w-full">
        <h1 className="text-4xl font-extrabold text-gray-500 mb-6">Terms and Conditions</h1>

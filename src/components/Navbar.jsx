...
const Navbar = () => {
    return (
        // Navbar Start
        <>
            <div className='w-[98.7 vw] h-auto py-[2.5vh] bg-gradient-to-r from-[#03AED2] to-[#FDDE55]  text-black  flex justify-between items-center gap-3 px-3 flex-col lg:flex-row  '>
                {/* Left side */}
